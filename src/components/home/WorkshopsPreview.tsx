            ...
            return (
              ...
              >
                ...
                <div className="p-5 flex flex-col gap-2 flex-1">
                  ...
                  <p className="text-sm text-amber-700">⏱️ {workshop.durationHours} שעות</p>
                  <p className="text-xs text-stone-400">מועד — ב-WhatsApp</p>
                  ...
                  <div className="flex justify-between items-center mt-2">
                    ...
                    <span className="text-xs text-stone-400">{formatWorkshopSeatsAvailability(available)}</span>
                  </div>
                  <Link
